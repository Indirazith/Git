...
public class HandCricket {
	...
	public static void main(String[] args) {
		...
		/** Constant target denoting the target for the second innings */
		int target = 0;
	...
	private static int play(String player) {
		...
		do {
			...
			numb = input.nextInt();
			falg = (numb<=6 && numb>=1)?false: true;
			count = (falg == true)? count+1:count;
			if(count>0) {
				String c = "Give a number between 1 - 6";
